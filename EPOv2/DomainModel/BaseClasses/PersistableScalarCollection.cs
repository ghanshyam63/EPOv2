...
namespace DomainModel.BaseClasses
{
    ...
    public abstract class PersistableScalarCollection<T> : ICollection<T>
    {
        ...
        /// Deriving classes can override the string that is used to seperate single values
        /// </summary>        
        protected virtual string[] ValueSeperators { get; } = new string[] { DefaultValueSeperator };
        ...
        public void AddRange(List<T> itemRange)
        {
            Data.AddRange(itemRange);
        }
