...
namespace EPOv2.Controllers
{
  ...
  public partial class AccountController : Controller
  {
    public AccountController()
          : this(new UserManager<User>(new UserStore<User>(new PurchaseOrderContext())))
    {
    }
    ...
    //      {
    //          AddNewProduct = false,
    //          GrowersToUsers = new List<GrowersToUsers>(),
    //          EmployeeId = 0
    //      };
